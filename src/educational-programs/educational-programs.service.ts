...
export class EducationalProgramsService {
   ...
   */
  async createProg(
    data: Prisma.EducationalProgramsCreateInput,
  ): Promise<EducationalPrograms> {
  ...
  async update(
    ...
    await this.byId(id);
    return await this.prisma.educationalPrograms.update({
      data: { ...updateEducationalProgramDto } as any,
      where: { id },
    });
  }
